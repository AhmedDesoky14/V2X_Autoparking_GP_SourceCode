...
#define IR_LED_1_Pin GPIO_PIN_4
#define IR_LED_1_GPIO_Port GPIOA
#define IR_LED_2_Pin GPIO_PIN_5
#define IR_LED_2_GPIO_Port GPIOA
#define IR_LED_3_Pin GPIO_PIN_6
#define IR_LED_3_GPIO_Port GPIOA
#define IR_LED_4_Pin GPIO_PIN_7
#define IR_LED_4_GPIO_Port GPIOA
...
#define IR_Sensor_3_Pin GPIO_PIN_2
#define IR_Sensor_3_GPIO_Port GPIOB
#define IR_Sensor_4_Pin GPIO_PIN_10
